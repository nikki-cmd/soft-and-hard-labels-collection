...
parser.add_argument('--config', type=str, required=True, 
                        help='Config module name (e.g. "config1" from configs/)')
...
loader = Loader(path=config.dataset_path)
...
uploader = AnswersUploader(path=config.dataset_path, answers=answers)
